...
function generateCard (employee,empRole){
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item">Email: <a href="mailto:${employee.email}" class="card-link">${employee.getEmail()}</a></li>
...
return `
    ...
    ${   empArr.forEach(employee =>{
        let empRole =employee.getRole();
        console.log(empRole);
        let output =generateCard(employee,empRole);
